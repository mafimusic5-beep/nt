...
$new = @'
            composable(EmeryRoute.Home.name) {
                ...
                LaunchedEffect(uiState.connectionState) {
                    when {
                        previousConnectionState != VpnConnectionState.Connected -and
                            uiState.connectionState -eq VpnConnectionState.Connected -> {
                        ...
                        previousConnectionState -eq VpnConnectionState.Connected -and
                            uiState.connectionState -eq VpnConnectionState.Disconnected -> {
