...
from device_id_slot_guard import install_device_id_slot_guard
...
@router.post('/api/device/recovery/challenge')
def identifier_slot_recovery_challenge(_payload: dict):
    return {
        'ok': True,
        'status': 'not_needed',
        'recovered': False,
