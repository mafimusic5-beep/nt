...
def save_device_pool_assignment_in_connection(
    ...
    cursor = con.execute(
        ...
        (
            ...
            int(assignment.get('pool_client_port') or 0) or None,
            str(assignment.get('pool_gate_host') or '')[:255],
            int(assignment.get('pool_gate_port') or 0) or None,
            str(assignment.get('pool_gate_server_name') or '')[:255],
            str(assignment.get('pool_gate_spki_sha256') or '')[:64],
